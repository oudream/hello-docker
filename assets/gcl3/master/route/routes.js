...
import archHis from '../views/his/arch-his.vue'
...
let routes = [
    ...
    },
    {
        ...
        children: [
            { path: '/Main', component: svgMain, name: '地图总览' }
        ]
    },
    {
        path: '/',
    ...
    },
    {
        ...
        children: [
            ...
            { path: '/app-lend-req', component: archLendReq, name: '借用申请' },
            { path: '/app-lend-confirm', component: archLendConfirm, name: '借用确认' },
            { path: '/app-revert-req', component: archRevertReq, name: '归还申请' },
            { path: '/app-revert-confirm', component: archRevertConfirm, name: '归还确认' },
            {path:'/app-arch-his', component: archHis, name: '出入记录'}
        ]
    },
    // {
    //     path: '/',
    ...
    // },
    {
        ...
        children: [
            ...
            { path: '/log-user', component: logUser, name: '监管人' },
            { path: '/log-reader', component: logReader, name: '借用人' },
    ...
    },
    {
        ...
        iconCls: 'el-icon-message',//图标样式class
        children: [
            { path: '/sys-user', component: archUser, name: '监管人' },
            { path: '/sys-cab', component: archCabinet, name: '图柜' },
            { path: '/sys-reader', component: archReader, name: '借用人' },
        ]
    },
    // {
    //     path: '/',
