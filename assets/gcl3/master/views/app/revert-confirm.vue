	...
	<section>
		...
		<el-col :span="24" class="toolbar" style="padding-bottom: 0px;">
			<el-form :inline="true" >
				...
				<el-form-item>
					<el-button type="primary"  @click="handleAction" :disabled="this.sels.length===0" >确认</el-button>
				</el-form-item>
				<!--<el-form-item>-->
		...
		<el-table ref="mainTable" :data="objs" highlight-current-row v-loading="listLoading" @selection-change="selsChange" style="width: 100%;">
			...
			<el-table-column prop="readerName" label="借阅人" width="120" sortable>
			</el-table-column>
			<el-table-column prop="monName" label="监管人" width="120" sortable>
			</el-table-column>
			<el-table-column prop="cntStd" label="归还数量" width="100" sortable>
			</el-table-column>
			<el-table-column prop="readerDT" label="归还时间" width="180" sortable>
			</el-table-column>
		...
		<!-- act -->
		<el-dialog title="地图确认" :visible.sync="actFormVisible" :close-on-click-modal="false"  v-dialog-drag top="1vh">
			<el-form :model="actForm" label-width="60px" :rules="actFormRules" ref="actForm">
				...
				<el-form-item label="数量">
					<el-input v-model="actForm.cntStd" :disabled = "true"></el-input>
				</el-form-item>
			</el-form>

			<div slot="footer" class="dialog-footer">
				<el-button @click.native="actFormVisible = false">取消</el-button>
				<el-button type="primary" @click.native="actSubmit" :loading="actLoading">确认</el-button>
			</div>
		</el-dialog>
		...
		<el-dialog title="地图档案详情"  :visible.sync="detailFormVisible" :close-on-click-modal="false" v-dialog-drag top="1vh">
			<el-form :model="detailForm" label-width="80px" :rules="detailFormRules" ref="detailForm">
				...
				<!--<el-input v-model="detailForm.monName" :disabled = "true"></el-input>-->
				<!--</el-form-item>-->
				<!--<el-form-item label="借阅时间">-->
				<!--<el-input v-model="detailForm.monDT" :disabled = "true"></el-input>-->
				<!--</el-form-item>-->
        ...
        data() {
            return {
                ...
                cfg_const:{
                    ...
                    sql_where_0:'WHERE a.{0}  LIKE \'%{0}%\' and a.f_dt_flag=0 and d.f_code=3 and d.f_syn_flag = 1 ',
                    sql_where_1:" WHERE a.f_dt_flag=0 and d.f_code=3 and d.f_syn_flag = 1 ",
                ...
                this.$refs.actForm.validate((valid) => {
                    if (valid) {
                        this.$confirm('确认归还吗？', '提示', {}).then(() => {
                            ...
                            let sv = util.formatString.format(' set f_status = {0},f_syn_flag = {1},f_cnt_std = f_cnt_std+{2},f_cnt_lend = f_cnt_lend-{3},f_cnt_good = f_cnt_good-{4}-{5},f_cnt_bad = f_cnt_bad+{6},f_cnt_lost = f_cnt_lost +{7} ',0,1,obj.cntStd,obj.cntStd,obj.cntBad,obj.cntLost,obj.cntBad,obj.cntLost);
