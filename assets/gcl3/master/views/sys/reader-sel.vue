    ...
    <el-dialog
        ...
        <el-row>
            ...
            <el-table ref="multipleTable" :data="objs" highlight-current-row v-loading="listLoading"
                ...
                <el-table-column prop="name" label="姓名" width="120" show-overflow-tooltip sortable></el-table-column>
                <el-table-column prop="uri" label="单位" width="120" sortable></el-table-column>
            </el-table>
        </el-row>

        <!-- operate toolbar on bottom -->
        <el-row :span="24" class="toolbar">
            <el-button @click="handleSubmit" :disabled="this.sels.length===0">确认选择</el-button>
        ...
        data() {
            return {
                ...
                cfg_const:{
                    ...
                    class:'READER',
                    user:'SYS',
                    sql_sel:'SELECT id as `id`,f_id as `uuid`,f_name as `name`,f_uri as `uri` FROM ti_obj_reader ',
