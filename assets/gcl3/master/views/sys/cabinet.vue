<template>
	<section>
		...
		<el-table ref="mainTable" :data="objs" highlight-current-row v-loading="listLoading" @selection-change="selsChange" style="width: 100%;">
			...
			<el-table-column prop="row" label="行" width="120" sortable>
			</el-table-column>
			<el-table-column prop="col" label="列" width="120"  sortable>
			</el-table-column>
			<el-table-column prop="lay" label="层" width="120" sortable>
			</el-table-column>
			<el-table-column prop="addrSta" label="站地址" width="120"sortable>
			</el-table-column>
			<el-table-column prop="addrYX" label="状态地址" width="120" sortable>
			</el-table-column>
			<el-table-column prop="addrYK" label="控制地址" width="120" sortable>
			</el-table-column>
		...
		<!-- edit -->
		<el-dialog title="档案柜编辑" :visible.sync="editFormVisible" :close-on-click-modal="false" v-dialog-drag top="1vh">
			<el-form :model="editForm" label-width="80px" :rules="editFormRules" ref="editForm">
				...
				<el-form-item label="行">
					<el-input v-model="editForm.row"></el-input>
				</el-form-item>
				<el-form-item label="列">
					<el-input v-model="editForm.col"></el-input>
				</el-form-item>
				<el-form-item label="层">
					<el-input v-model="editForm.lay"></el-input>
				</el-form-item>
				<el-form-item label="站地址">
					<el-input v-model="editForm.addrSta"></el-input>
				</el-form-item>
				<el-form-item label="控制地址">
					<el-input v-model="editForm.addrYK"></el-input>
				</el-form-item>
		...
		<!-- add -->
		<el-dialog title="档案柜新增" :visible.sync="addFormVisible" :close-on-click-modal="false" v-dialog-drag top="1vh">
			<el-form :model="addForm" label-width="80px" :rules="addFormRules" ref="addForm">
				...
				<el-form-item label="层">
					<el-input v-model="addForm.lay"></el-input>
				</el-form-item>
				<el-form-item label="站地址">
					<el-input v-model="addForm.addrSta"></el-input>
				</el-form-item>
				<el-form-item label="状态地址">
					<el-input v-model="addForm.addrYX"></el-input>
				</el-form-item>
				<el-form-item label="控制地址">
					<el-input v-model="addForm.addrYK"></el-input>
				</el-form-item>
				<el-form-item label="备注">
		...
		data() {
			return {
                ...
                cfg_ti_obj:{
                    ...
                    uuid:{name:'f_id'},
                    name:{name:'f_name',desc:'名称'},
                    uri:{name:'f_uri',desc:'编号'},
                    col:{name:'f_col',desc:'列',type:'number',def:1},
                    row:{name:'f_row',desc:'行',type:'number',def:1},
                    lay:{name:'f_lay',desc:'层',type:'number',def:1},
                    addrSta:{name:'f_addr_sta',desc:'站地址',type:'number',def:1},
                    addrYX:{name:'f_addr_yx',desc:'状态地址',type:'number',def:1},
                    addrYK:{name:'f_addr_yk',desc:'控制地址',type:'number',def:1},
...
//                    st_flag:{name:'f_st_flag',type:'number',def:0},
				...
				cfg_const:{
				  ...
				  class:'CAB',
				  user:'SYS',
				  sql_sel:'SELECT id as `id`,f_id as `uuid`,f_name as `name`,f_uri as `uri`,f_col as `col`,f_row as `row`,f_lay as `lay`,f_addr_sta as `addrSta`,f_addr_yx as `addrYX`, f_addr_yk as `addrYK` FROM ti_obj_cab ',
