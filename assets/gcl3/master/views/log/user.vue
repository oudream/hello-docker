		...
		data() {
			return {
                ...
                cfg_const:{
					...
					'from ti_log_user a left join ti_obj_user b on a.f_pid = b.f_id',
                    sql_max_id:'SELECT MAX(a.id) as max_id FROM ti_log_user a',
                    sql_del:'update ti_log_user a set a.f_dt_flag = -1 WHERE a.id = ',
                    sql_rec_cnt:'SELECT COUNT(a.id) as count_rec FROM ti_log_user a',
