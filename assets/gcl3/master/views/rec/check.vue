	...
	<section>
		...
		<el-col :span="24" class="toolbar" style="padding-bottom: 0px;">
			<el-form :inline="true" >
				...
				<el-form-item>
					<el-button type="primary"  @click="handleEdit" :disabled="this.sels.length===0" >盘点</el-button>
				</el-form-item>
				<el-form-item>
		...
		<!-- edit -->
		<el-dialog title="地图状态盘点" :visible.sync="editFormVisible" :close-on-click-modal="false" v-dialog-drag top="1vh">
			<el-form :model="editForm" label-width="60px" :rules="editFormRules" ref="editForm">
				...
				<el-form-item label="总数">
					<el-input v-model="editForm.count" :disabled="true"  ></el-input>
				</el-form-item>
				<el-form-item label="位置">
					<el-input v-model="editForm.pos" :disabled="true">
						<el-button slot="append" icon="el-icon-search" @click.native="editCabSelVisible=true"></el-button>
					</el-input>
					<cabSel :visible.sync="editCabSelVisible" :sels_ids="[editForm.posId]" @submit="handleCabFormSubmit"></cabSel>
				</el-form-item>
				...
				<el-form-item label="数量">
					...
					<el-col :span="3" align="center">库存</el-col>
					<el-col :span="3" >
						<el-input v-model="editForm.cntStd"></el-input>
					</el-col>

					<el-col :span="3" align="center">借出</el-col>
					<el-col :span="3" >
						<el-input v-model="editForm.cntLend"></el-input>
					</el-col>
				</el-form-item>
				<el-form-item label="质量">
					<el-col :span="3" align="center">完好</el-col>
					<el-col :span="3" >
						<el-input v-model="editForm.cntGood"></el-input>
					</el-col>

					<el-col :span="3" align="center">破损</el-col>
					<el-col :span="3">
						<el-input v-model="editForm.cntBad"></el-input>
					</el-col>

					<el-col :span="3" align="center">丢失</el-col>
					<el-col :span="3">
						<el-input v-model="editForm.cntLost"></el-input>
					</el-col>
				</el-form-item>
		...
		<el-dialog title="地图档案详情"  :visible.sync="detailFormVisible" :close-on-click-modal="false" v-dialog-drag top="1vh">
			<el-form :model="detailForm" label-width="80px" :rules="detailFormRules" ref="detailForm">
				...
				<el-form-item label="数量">
					<el-col :span="3" align="center">库存</el-col>
					<el-col :span="3" >
						<el-input v-model="detailForm.cntStd" :disabled = "true" ></el-input>
					</el-col>
					<el-col :span="3" align="center">借出</el-col>
					<el-col :span="3" >
...
<script>
    ...
    import cabSel from '../sys/cab-sel.vue';
	...
	export default {
		...
		methods: {
            ...
            handleCabFormSubmit: function(a) {
                if (Array.isArray(a)) {
                    this.editForm.posId   = a[0].uuid;
                    this.editForm.pos      = a[0].name;
                }
            },
			// submit edit
			editSubmit: function () {
				this.$refs.editForm.validate((valid) => {
					if (valid) {
						this.$confirm('确认提交吗？', '提示', {}).then(() => {
                            ...
                            let conds = 'f_id = \''+obj.uuid+'\'';
                            let r1 = dbCommon.sql.getUpdate(this.cfg_const.obj,this.cfg_ti_obj,this.editForm,this.editFormOld,conds);

                            this.editForm.cntStd = this.editForm.count - this.editForm.cntLost;
                            let r2 = dbCommon.sql.getUpdate(this.cfg_const.st,this.cfg_ti_st,this.editForm,this.editFormOld,conds);
                            let desc="";
                            let ok = false;
                            if(r1.err == false)
                            {
