<template>
    <section>
        <div v-for="(bureauId, index) in bureauIds">
            <CurveView odc-name="container_stat" :id-name="'show-ht-curve-'+bureauId" :title="'服务实例 '+bureauId+'的内存峰值历史数据'" :fields="fields" :conditions="getConditions(bureauId)"></CurveView>
        </div>
    </section>
</template>
