<template>
	<section>
		...
		<el-col :span="24" class="toolbar" style="padding-bottom: 0px;">
			<el-form :inline="true" >
				<el-form-item label="属性" width="60">
				...
				<el-form-item label="值" width="60">
					<el-input v-model="filter.value" placeholder="值"></el-input>
				</el-form-item>
				<el-form-item label="开始" width="60">
					<el-date-picker type="date" placeholder="选择日期" v-model="dt_start" style="width: 60;"></el-date-picker>
				</el-form-item>
				<el-form-item label="结束" width="60">
					<el-date-picker type="date" placeholder="选择日期" v-model="dt_end" style="width: 60;"></el-date-picker>
				</el-form-item>
				<el-form-item>
		...
		<el-table ref="mainTable" :data="objs" highlight-current-row v-loading="listLoading" @selection-change="selsChange" style="width: 100%;">
			...
			<el-table-column prop="code" label="动作" width="100" :formatter="formatCode" sortable>
			</el-table-column>
			<el-table-column prop="readerName" label="借用人" width="100" sortable>
			</el-table-column>
			<el-table-column prop="monName" label="监管人" width="100" sortable>
			</el-table-column>
			<el-table-column prop="cntStd" label="发生数量" width="100" sortable>
			</el-table-column>
			<el-table-column prop="readerDT" label="发生时间" width="180" sortable>
			</el-table-column>
    ...
    export default {
        ...
        data() {
            return {
                ...
                cfg_const:{
                    ...
                    'd.f_id_mon as `monId` ,d.f_id_reader as `readerId`,d.f_code as `code`,e.f_name as  `monName`,f.f_name as `readerName` ' +
                    ...
                    sql_where_0:'WHERE {0}  LIKE \'%{1}%\' and a.f_dt_flag=0 and d.f_t_reader>={2} and d.f_t_reader<{3}',
                    sql_where_1:" WHERE a.f_dt_flag=0 and d.f_t_reader>={0} and d.f_t_reader<{1}",
                    sql_order:" order by d.f_t_reader desc",
        ...
        methods: {
            ...
            formatCode: function (row, column) {
                ...
                if (v ===1) return '借用申请';
                else if(v ===2) return '借用确认';
                else if (v===3) return '归还申请';
                else if (v===4) return '归还确认';
                else return '未知';
                ...
                this.$refs.actForm.validate((valid) => {
                    if (valid) {
                        this.$confirm('确认归还吗？', '提示', {}).then(() => {
                            ...
                            let sv = util.formatString.format(' set f_status = {0},f_syn_flag = {1},f_cnt_std = f_cnt_std + {2},f_cnt_lend = f_cnt_lend - {3} ',0,1,obj.cntStd,obj.cntStd);
