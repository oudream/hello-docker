<template>
    <el-row class="login-bg" v-bind:class="{ 'background': backGroundImage }">
        <el-form :model="editForm" label-width="80px" :rules="editFormRules" ref="editForm">
            ...
            <el-form-item>
                <el-button @click.native="cancelEdit = false">取　消</el-button>
                <el-button type="primary" @click.native="handleEdit" :loading="editLoading">提交验证</el-button>
            </el-form-item>
    ...
    export default {
        ...
        methods: {
            ...
            handleEdit: function() {
                ...
                let conditions = [];
                this.attrs.forEach(atr => conditions.push({
                    attrs: [
                        {
                            name: atr.name,
                            operation: '=',
