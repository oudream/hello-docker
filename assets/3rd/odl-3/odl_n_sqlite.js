(function() {
    ...
    odl.DbSqlite = {
        ...
        _createSql: function(table, attrs){
            ...
            for (let i = 0; i < attrs.length; i++) {
                ...
                let sAutoIncrement = '';
                if (Array.isArray(keys) && keys.indexOf(attr.name)>=0) {
                    if (attr.autoIncrement && attr.autoIncrement > 0) {
                        sAutoIncrement = ' PRIMARY KEY AUTOINCREMENT';
                    } else {
        ...
        log: {
            ...
            normalize: function(odc, nObj) {
                ...
                for (let i = 0; i < this.fixFields.length; i++) {
                    ...
                    attr2.field = {
                        ...
                        fieldType: DbSqlite.fieldTypes[attr1.type]
                    };
                    attrs.push(attr2);
                }
            ...
            getCreateSql: function(odc) {
                let DbSqlite = odl.DbSqlite;
                let nObj = DbSqlite.getSimilar(odc);
                if (nObj && nObj.spec.log && nObj.spec.log.table && nObj.spec.log.attrs) {
                    return DbSqlite._createSql(nObj.spec.log.table, nObj.spec.log.attrs);
                }
                return '';
            },
            ...
            getInsertSqlAry: function(odc, objs, logEnv) {
                ...
                if (nObj && nObj.spec.log && nObj.spec.log.table && nObj.spec.log.attrs) {
                    ...
                    return DbSqlite._insertSqlAry(nObj.spec.log.table, nObj.spec.log.attrs, objs);
                }
                return null;
            },
        }
    ...
    odl.registerNPlugin(odl.DbSqlite);
})();
